...
func DeletenamespacedpoddisruptionbudgetHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateDeletenamespacedpoddisruptionbudgetTool(cfg *config.APIConfig) models.Tool {
	...
	return models.Tool{
		Definition: tool,
		Handler:    DeletenamespacedpoddisruptionbudgetHandler(cfg),
	}
}
