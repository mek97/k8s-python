...
func ReplacenamespacedpoddisruptionbudgetstatusHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateReplacenamespacedpoddisruptionbudgetstatusTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_apis_policy_v1_namespaces_namespace_poddisruptionbudgets",
	...
	return models.Tool{
		Definition: tool,
		Handler:    ReplacenamespacedpoddisruptionbudgetstatusHandler(cfg),
	}
}
