...
func PatchnamespacedpoddisruptionbudgetstatusHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreatePatchnamespacedpoddisruptionbudgetstatusTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("patch_apis_policy_v1_namespaces_namespace",
	...
	return models.Tool{
		Definition: tool,
		Handler:    PatchnamespacedpoddisruptionbudgetstatusHandler(cfg),
	}
}
