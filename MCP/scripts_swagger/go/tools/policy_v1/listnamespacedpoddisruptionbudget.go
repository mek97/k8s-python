...
func ListnamespacedpoddisruptionbudgetHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateListnamespacedpoddisruptionbudgetTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_apis_policy_v1_namespaces_namespace_2",
	...
	return models.Tool{
		Definition: tool,
		Handler:    ListnamespacedpoddisruptionbudgetHandler(cfg),
	}
}
