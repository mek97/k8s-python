...
func DeletecollectionnamespacedpoddisruptionbudgetHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateDeletecollectionnamespacedpoddisruptionbudgetTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_apis_policy_v1_namespaces_namespace",
	...
	return models.Tool{
		Definition: tool,
		Handler:    DeletecollectionnamespacedpoddisruptionbudgetHandler(cfg),
	}
}
