...
func CreatenamespacedpoddisruptionbudgetHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateCreatenamespacedpoddisruptionbudgetTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_apis_policy_v1_namespaces_namespace",
	...
	return models.Tool{
		Definition: tool,
		Handler:    CreatenamespacedpoddisruptionbudgetHandler(cfg),
	}
}
