...
func PatchclustertrustbundleHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreatePatchclustertrustbundleTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("patch_apis_certificates_k8s_io_v1alpha1_clustertrustbundles",
	...
	return models.Tool{
		Definition: tool,
		Handler:    PatchclustertrustbundleHandler(cfg),
	}
}
