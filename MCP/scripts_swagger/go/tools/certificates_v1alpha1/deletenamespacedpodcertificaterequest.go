...
func DeletenamespacedpodcertificaterequestHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateDeletenamespacedpodcertificaterequestTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_apis_certificates_k8s_io_v1alpha1_namespaces",
		mcp.WithDescription("delete a PodCertificateRequest"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    DeletenamespacedpodcertificaterequestHandler(cfg),
	}
}
