...
func PatchnamespacedpodcertificaterequestHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/apis/certificates.k8s.io/v1alpha1/namespaces/%s/podcertificaterequests/%s%s", cfg.BaseURL, queryString)
...
func CreatePatchnamespacedpodcertificaterequestTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("patch_apis_certificates_k8s_io_v1alpha1_namespaces_namespace",
		mcp.WithDescription("partially update the specified PodCertificateRequest"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    PatchnamespacedpodcertificaterequestHandler(cfg),
	}
}
