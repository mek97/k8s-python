...
func ListnamespacedpodcertificaterequestHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateListnamespacedpodcertificaterequestTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_apis_certificates_k8s_io_v1alpha1_namespaces_namespace",
		mcp.WithDescription("list or watch objects of kind PodCertificateRequest"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    ListnamespacedpodcertificaterequestHandler(cfg),
	}
}
