...
func DeletecollectionnamespacedpodcertificaterequestHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/apis/certificates.k8s.io/v1alpha1/namespaces/%s/podcertificaterequests%s", cfg.BaseURL, queryString)
...
func CreateDeletecollectionnamespacedpodcertificaterequestTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_apis_certificates_k8s_io_v1alpha1_namespaces",
		mcp.WithDescription("delete collection of PodCertificateRequest"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    DeletecollectionnamespacedpodcertificaterequestHandler(cfg),
	}
}
