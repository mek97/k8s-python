...
func CreatenamespacedpodcertificaterequestHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateCreatenamespacedpodcertificaterequestTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_apis_certificates_k8s_io_v1alpha1_namespaces_namespace",
		mcp.WithDescription("create a PodCertificateRequest"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    CreatenamespacedpodcertificaterequestHandler(cfg),
	}
}
