...
func ReplacenamespacedpodcertificaterequeststatusHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateReplacenamespacedpodcertificaterequeststatusTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_apis_certificates_k8s_io_v1alpha1_namespaces_namespace",
		mcp.WithDescription("replace status of the specified PodCertificateRequest"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    ReplacenamespacedpodcertificaterequeststatusHandler(cfg),
	}
}
