...
func ReplacenamespacedendpointsliceHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateReplacenamespacedendpointsliceTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_apis_discovery_k8s_io_v1_namespaces_namespace",
	...
	return models.Tool{
		Definition: tool,
		Handler:    ReplacenamespacedendpointsliceHandler(cfg),
	}
}
