...
func CreatenamespacedendpointsliceHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateCreatenamespacedendpointsliceTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_apis_discovery_k8s_io_v1_namespaces_namespace",
	...
	return models.Tool{
		Definition: tool,
		Handler:    CreatenamespacedendpointsliceHandler(cfg),
	}
}
