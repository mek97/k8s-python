...
func ReadnamespacedcronjobstatusHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateReadnamespacedcronjobstatusTool(cfg *config.APIConfig) models.Tool {
	...
	return models.Tool{
		Definition: tool,
		Handler:    ReadnamespacedcronjobstatusHandler(cfg),
	}
}
