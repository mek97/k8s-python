...
func ReplacedeviceclassHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateReplacedeviceclassTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_apis_resource_k8s_io_v1beta1_deviceclasses_name",
	...
	return models.Tool{
		Definition: tool,
		Handler:    ReplacedeviceclassHandler(cfg),
	}
}
