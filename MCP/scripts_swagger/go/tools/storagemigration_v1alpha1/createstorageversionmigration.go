...
func CreatestorageversionmigrationHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateCreatestorageversionmigrationTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_apis_storagemigration_k8s_io_v1alpha1",
	...
	return models.Tool{
		Definition: tool,
		Handler:    CreatestorageversionmigrationHandler(cfg),
	}
}
