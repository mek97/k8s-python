...
func ReplacestorageversionmigrationstatusHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateReplacestorageversionmigrationstatusTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_apis_storagemigration_k8s_io_v1alpha1",
	...
	return models.Tool{
		Definition: tool,
		Handler:    ReplacestorageversionmigrationstatusHandler(cfg),
	}
}
