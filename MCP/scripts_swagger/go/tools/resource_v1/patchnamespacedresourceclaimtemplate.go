...
func PatchnamespacedresourceclaimtemplateHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreatePatchnamespacedresourceclaimtemplateTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("patch_apis_resource_k8s_io_v1_namespaces_namespace",
	...
	return models.Tool{
		Definition: tool,
		Handler:    PatchnamespacedresourceclaimtemplateHandler(cfg),
	}
}
