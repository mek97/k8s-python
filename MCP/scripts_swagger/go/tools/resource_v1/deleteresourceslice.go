...
func DeleteresourcesliceHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateDeleteresourcesliceTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_apis_resource_k8s_io_v1_resourceslices_name",
	...
	return models.Tool{
		Definition: tool,
		Handler:    DeleteresourcesliceHandler(cfg),
	}
}
