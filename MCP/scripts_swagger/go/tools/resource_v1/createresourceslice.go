...
func CreateresourcesliceHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateCreateresourcesliceTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_apis_resource_k8s_io_v1_resourceslices",
	...
	return models.Tool{
		Definition: tool,
		Handler:    CreateresourcesliceHandler(cfg),
	}
}
