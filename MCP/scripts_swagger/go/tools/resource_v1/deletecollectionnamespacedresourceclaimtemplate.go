...
func DeletecollectionnamespacedresourceclaimtemplateHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/apis/resource.k8s.io/v1/namespaces/%s/resourceclaimtemplates%s", cfg.BaseURL, queryString)
...
func CreateDeletecollectionnamespacedresourceclaimtemplateTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_apis_resource_k8s_io_v1_namespaces_namespace",
	...
	return models.Tool{
		Definition: tool,
		Handler:    DeletecollectionnamespacedresourceclaimtemplateHandler(cfg),
	}
}
