...
func ListdeviceclassHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateListdeviceclassTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_apis_resource_k8s_io_v1_deviceclasses",
	...
	return models.Tool{
		Definition: tool,
		Handler:    ListdeviceclassHandler(cfg),
	}
}
