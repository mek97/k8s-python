...
func CreatenamespacedresourceclaimHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateCreatenamespacedresourceclaimTool(cfg *config.APIConfig) models.Tool {
	...
	return models.Tool{
		Definition: tool,
		Handler:    CreatenamespacedresourceclaimHandler(cfg),
	}
}
