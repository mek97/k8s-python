...
func PatchclustercustomobjectHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreatePatchclustercustomobjectTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("patch_apis_group_version_plural_name",
		mcp.WithDescription("patch the specified cluster scoped custom object"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    PatchclustercustomobjectHandler(cfg),
	}
}
