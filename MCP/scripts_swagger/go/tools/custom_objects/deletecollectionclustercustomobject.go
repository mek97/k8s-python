...
func DeletecollectionclustercustomobjectHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/apis/%s/%s/%s%s", cfg.BaseURL, queryString)
...
func CreateDeletecollectionclustercustomobjectTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_apis_group_version_plural",
		mcp.WithDescription("Delete collection of cluster scoped custom objects"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    DeletecollectionclustercustomobjectHandler(cfg),
	}
}
