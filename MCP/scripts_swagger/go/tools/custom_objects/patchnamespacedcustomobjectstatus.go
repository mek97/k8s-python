...
func PatchnamespacedcustomobjectstatusHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/apis/%s/%s/namespaces/%s/%s/%s/status%s", cfg.BaseURL, queryString)
...
func CreatePatchnamespacedcustomobjectstatusTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("patch_apis_group_version_namespaces_namespace_plural_name",
		mcp.WithDescription("partially update status of the specified namespace scoped custom object"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    PatchnamespacedcustomobjectstatusHandler(cfg),
	}
}
