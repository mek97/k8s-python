...
func ListclustercustomobjectHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateListclustercustomobjectTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_apis_group_version_plural",
		mcp.WithDescription("list or watch cluster scoped custom objects"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    ListclustercustomobjectHandler(cfg),
	}
}
