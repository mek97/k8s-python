...
func CreateclustercustomobjectHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateCreateclustercustomobjectTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_apis_group_version_plural",
		mcp.WithDescription("Creates a cluster scoped Custom object"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    CreateclustercustomobjectHandler(cfg),
	}
}
