...
func DeletenamespacedcustomobjectHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/apis/%s/%s/namespaces/%s/%s/%s%s", cfg.BaseURL, queryString)
...
func CreateDeletenamespacedcustomobjectTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_apis_group_version_namespaces_namespace_plural_name",
		mcp.WithDescription("Deletes the specified namespace scoped custom object"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    DeletenamespacedcustomobjectHandler(cfg),
	}
}
