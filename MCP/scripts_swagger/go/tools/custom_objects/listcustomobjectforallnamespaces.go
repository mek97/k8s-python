...
func ListcustomobjectforallnamespacesHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateListcustomobjectforallnamespacesTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_apis_group_version_resource_plural",
	...
	return models.Tool{
		Definition: tool,
		Handler:    ListcustomobjectforallnamespacesHandler(cfg),
	}
}
