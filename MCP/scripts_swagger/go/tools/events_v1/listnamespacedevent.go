...
func ListnamespacedeventHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateListnamespacedeventTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_apis_events_k8s_io_v1_namespaces_namespace",
	...
	return models.Tool{
		Definition: tool,
		Handler:    ListnamespacedeventHandler(cfg),
	}
}
