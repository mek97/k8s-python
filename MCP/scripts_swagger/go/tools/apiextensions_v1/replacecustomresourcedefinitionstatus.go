...
func ReplacecustomresourcedefinitionstatusHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateReplacecustomresourcedefinitionstatusTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_apis_apiextensions_k8s_io_v1_customresourcedefinitions",
	...
	return models.Tool{
		Definition: tool,
		Handler:    ReplacecustomresourcedefinitionstatusHandler(cfg),
	}
}
