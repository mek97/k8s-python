...
func ListcustomresourcedefinitionHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateListcustomresourcedefinitionTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_apis_apiextensions_k8s_io_v1_customresourcedefinitions_2",
	...
	return models.Tool{
		Definition: tool,
		Handler:    ListcustomresourcedefinitionHandler(cfg),
	}
}
