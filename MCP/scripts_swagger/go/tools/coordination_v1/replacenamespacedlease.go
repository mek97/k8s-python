...
func ReplacenamespacedleaseHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateReplacenamespacedleaseTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_apis_coordination_k8s_io_v1_namespaces_namespace_leases",
	...
	return models.Tool{
		Definition: tool,
		Handler:    ReplacenamespacedleaseHandler(cfg),
	}
}
