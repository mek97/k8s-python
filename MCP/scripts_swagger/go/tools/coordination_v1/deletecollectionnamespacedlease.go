...
func DeletecollectionnamespacedleaseHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateDeletecollectionnamespacedleaseTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_apis_coordination_k8s_io_v1_namespaces_namespace",
	...
	return models.Tool{
		Definition: tool,
		Handler:    DeletecollectionnamespacedleaseHandler(cfg),
	}
}
