...
func PatchdeviceclassHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreatePatchdeviceclassTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("patch_apis_resource_k8s_io_v1beta2_deviceclasses_name",
		mcp.WithDescription("partially update the specified DeviceClass"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    PatchdeviceclassHandler(cfg),
	}
}
