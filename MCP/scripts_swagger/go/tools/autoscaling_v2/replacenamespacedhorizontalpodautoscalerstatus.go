...
func ReplacenamespacedhorizontalpodautoscalerstatusHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateReplacenamespacedhorizontalpodautoscalerstatusTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_apis_autoscaling_v2_namespaces_namespace",
	...
	return models.Tool{
		Definition: tool,
		Handler:    ReplacenamespacedhorizontalpodautoscalerstatusHandler(cfg),
	}
}
