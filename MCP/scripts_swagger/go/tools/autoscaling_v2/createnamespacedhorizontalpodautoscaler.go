...
func CreatenamespacedhorizontalpodautoscalerHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateCreatenamespacedhorizontalpodautoscalerTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_apis_autoscaling_v2_namespaces_namespace",
	...
	return models.Tool{
		Definition: tool,
		Handler:    CreatenamespacedhorizontalpodautoscalerHandler(cfg),
	}
}
