...
func DeleteflowschemaHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateDeleteflowschemaTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_apis_flowcontrol_apiserver_k8s_io_v1_flowschemas_name",
	...
	return models.Tool{
		Definition: tool,
		Handler:    DeleteflowschemaHandler(cfg),
	}
}
