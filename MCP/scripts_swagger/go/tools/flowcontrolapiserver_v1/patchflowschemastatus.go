...
func PatchflowschemastatusHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreatePatchflowschemastatusTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("patch_apis_flowcontrol_apiserver_k8s_io_v1_flowschemas_name",
	...
	return models.Tool{
		Definition: tool,
		Handler:    PatchflowschemastatusHandler(cfg),
	}
}
