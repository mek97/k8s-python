...
func CreateprioritylevelconfigurationHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateCreateprioritylevelconfigurationTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_apis_flowcontrol_apiserver_k8s_io_v1",
	...
	return models.Tool{
		Definition: tool,
		Handler:    CreateprioritylevelconfigurationHandler(cfg),
	}
}
