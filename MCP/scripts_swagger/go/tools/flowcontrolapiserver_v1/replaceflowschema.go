...
func ReplaceflowschemaHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateReplaceflowschemaTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_apis_flowcontrol_apiserver_k8s_io_v1_flowschemas_name_2",
	...
	return models.Tool{
		Definition: tool,
		Handler:    ReplaceflowschemaHandler(cfg),
	}
}
