...
func PatchflowschemaHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreatePatchflowschemaTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("patch_apis_flowcontrol_apiserver_k8s_io_v1_flowschemas_2",
	...
	return models.Tool{
		Definition: tool,
		Handler:    PatchflowschemaHandler(cfg),
	}
}
