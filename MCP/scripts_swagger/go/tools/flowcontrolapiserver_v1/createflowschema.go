...
func CreateflowschemaHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateCreateflowschemaTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_apis_flowcontrol_apiserver_k8s_io_v1_flowschemas",
	...
	return models.Tool{
		Definition: tool,
		Handler:    CreateflowschemaHandler(cfg),
	}
}
