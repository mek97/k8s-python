...
func ReadcertificatesigningrequeststatusHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateReadcertificatesigningrequeststatusTool(cfg *config.APIConfig) models.Tool {
	...
	return models.Tool{
		Definition: tool,
		Handler:    ReadcertificatesigningrequeststatusHandler(cfg),
	}
}
