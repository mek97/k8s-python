...
func ListcertificatesigningrequestHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateListcertificatesigningrequestTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_apis_certificates_k8s_io_v1_certificatesigningrequests_2",
	...
	return models.Tool{
		Definition: tool,
		Handler:    ListcertificatesigningrequestHandler(cfg),
	}
}
