...
func ReplacecertificatesigningrequestapprovalHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateReplacecertificatesigningrequestapprovalTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_apis_certificates_k8s_io_v1_certificatesigningrequests",
	...
	return models.Tool{
		Definition: tool,
		Handler:    ReplacecertificatesigningrequestapprovalHandler(cfg),
	}
}
