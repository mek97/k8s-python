...
func PatchcertificatesigningrequestapprovalHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreatePatchcertificatesigningrequestapprovalTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("patch_apis_certificates_k8s_io_v1_certificatesigningrequests",
	...
	return models.Tool{
		Definition: tool,
		Handler:    PatchcertificatesigningrequestapprovalHandler(cfg),
	}
}
