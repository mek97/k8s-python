...
func DeletecollectioncertificatesigningrequestHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateDeletecollectioncertificatesigningrequestTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_apis_certificates_k8s_io_v1",
	...
	return models.Tool{
		Definition: tool,
		Handler:    DeletecollectioncertificatesigningrequestHandler(cfg),
	}
}
