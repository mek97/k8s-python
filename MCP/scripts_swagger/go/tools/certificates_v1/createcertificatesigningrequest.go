...
func CreatecertificatesigningrequestHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateCreatecertificatesigningrequestTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_apis_certificates_k8s_io_v1_certificatesigningrequests",
	...
	return models.Tool{
		Definition: tool,
		Handler:    CreatecertificatesigningrequestHandler(cfg),
	}
}
