...
func ListdevicetaintruleHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateListdevicetaintruleTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_apis_resource_k8s_io_v1alpha3_devicetaintrules",
	...
	return models.Tool{
		Definition: tool,
		Handler:    ListdevicetaintruleHandler(cfg),
	}
}
