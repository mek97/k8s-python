...
func DeletedevicetaintruleHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateDeletedevicetaintruleTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_apis_resource_k8s_io_v1alpha3_devicetaintrules_name",
	...
	return models.Tool{
		Definition: tool,
		Handler:    DeletedevicetaintruleHandler(cfg),
	}
}
