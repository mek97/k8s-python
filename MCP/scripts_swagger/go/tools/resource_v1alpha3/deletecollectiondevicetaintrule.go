...
func DeletecollectiondevicetaintruleHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateDeletecollectiondevicetaintruleTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_apis_resource_k8s_io_v1alpha3_devicetaintrules",
	...
	return models.Tool{
		Definition: tool,
		Handler:    DeletecollectiondevicetaintruleHandler(cfg),
	}
}
