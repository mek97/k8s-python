...
func PatchdevicetaintruleHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreatePatchdevicetaintruleTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("patch_apis_resource_k8s_io_v1alpha3_devicetaintrules_name",
		mcp.WithDescription("partially update the specified DeviceTaintRule"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    PatchdevicetaintruleHandler(cfg),
	}
}
