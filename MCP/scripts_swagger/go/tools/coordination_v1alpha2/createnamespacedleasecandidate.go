...
func CreatenamespacedleasecandidateHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateCreatenamespacedleasecandidateTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_apis_coordination_k8s_io_v1alpha2_namespaces_namespace",
	...
	return models.Tool{
		Definition: tool,
		Handler:    CreatenamespacedleasecandidateHandler(cfg),
	}
}
