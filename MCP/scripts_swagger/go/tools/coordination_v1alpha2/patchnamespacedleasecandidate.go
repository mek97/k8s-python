...
func PatchnamespacedleasecandidateHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreatePatchnamespacedleasecandidateTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("patch_apis_coordination_k8s_io_v1alpha2_namespaces_namespace",
		mcp.WithDescription("partially update the specified LeaseCandidate"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    PatchnamespacedleasecandidateHandler(cfg),
	}
}
