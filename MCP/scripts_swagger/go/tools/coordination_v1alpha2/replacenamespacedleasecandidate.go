...
func ReplacenamespacedleasecandidateHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateReplacenamespacedleasecandidateTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_apis_coordination_k8s_io_v1alpha2_namespaces_namespace",
	...
	return models.Tool{
		Definition: tool,
		Handler:    ReplacenamespacedleasecandidateHandler(cfg),
	}
}
