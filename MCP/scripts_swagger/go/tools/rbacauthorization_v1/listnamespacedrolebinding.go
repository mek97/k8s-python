...
func ListnamespacedrolebindingHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateListnamespacedrolebindingTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_apis_rbac_authorization_k8s_io_v1_namespaces_namespace",
	...
	return models.Tool{
		Definition: tool,
		Handler:    ListnamespacedrolebindingHandler(cfg),
	}
}
