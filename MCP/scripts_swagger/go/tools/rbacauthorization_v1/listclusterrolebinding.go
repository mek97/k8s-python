...
func ListclusterrolebindingHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateListclusterrolebindingTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_apis_rbac_authorization_k8s_io_v1_clusterrolebindings_2",
	...
	return models.Tool{
		Definition: tool,
		Handler:    ListclusterrolebindingHandler(cfg),
	}
}
