...
func PatchclusterrolebindingHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreatePatchclusterrolebindingTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("patch_apis_rbac_authorization_k8s_io_v1_clusterrolebindings",
	...
	return models.Tool{
		Definition: tool,
		Handler:    PatchclusterrolebindingHandler(cfg),
	}
}
