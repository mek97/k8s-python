...
func ReplacenamespacedrolebindingHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateReplacenamespacedrolebindingTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_apis_rbac_authorization_k8s_io_v1_namespaces_namespace",
	...
	return models.Tool{
		Definition: tool,
		Handler:    ReplacenamespacedrolebindingHandler(cfg),
	}
}
