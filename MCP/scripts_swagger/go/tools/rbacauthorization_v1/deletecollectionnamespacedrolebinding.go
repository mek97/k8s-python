...
func DeletecollectionnamespacedrolebindingHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateDeletecollectionnamespacedrolebindingTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_apis_rbac_authorization_k8s_io_v1_namespaces",
	...
	return models.Tool{
		Definition: tool,
		Handler:    DeletecollectionnamespacedrolebindingHandler(cfg),
	}
}
