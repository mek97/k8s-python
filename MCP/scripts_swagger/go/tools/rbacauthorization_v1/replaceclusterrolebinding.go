...
func ReplaceclusterrolebindingHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateReplaceclusterrolebindingTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_apis_rbac_authorization_k8s_io_v1_clusterrolebindings",
	...
	return models.Tool{
		Definition: tool,
		Handler:    ReplaceclusterrolebindingHandler(cfg),
	}
}
