...
func DeletecollectionnamespacedleasecandidateHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateDeletecollectionnamespacedleasecandidateTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_apis_coordination_k8s_io_v1beta1_namespaces_namespace",
	...
	return models.Tool{
		Definition: tool,
		Handler:    DeletecollectionnamespacedleasecandidateHandler(cfg),
	}
}
