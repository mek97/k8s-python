...
func DeletecollectionpriorityclassHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateDeletecollectionpriorityclassTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_apis_scheduling_k8s_io_v1_priorityclasses",
	...
	return models.Tool{
		Definition: tool,
		Handler:    DeletecollectionpriorityclassHandler(cfg),
	}
}
