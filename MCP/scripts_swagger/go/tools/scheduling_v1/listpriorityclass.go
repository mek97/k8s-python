...
func ListpriorityclassHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateListpriorityclassTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_apis_scheduling_k8s_io_v1_priorityclasses",
	...
	return models.Tool{
		Definition: tool,
		Handler:    ListpriorityclassHandler(cfg),
	}
}
