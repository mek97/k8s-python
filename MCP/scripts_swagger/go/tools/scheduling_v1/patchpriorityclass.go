...
func PatchpriorityclassHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreatePatchpriorityclassTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("patch_apis_scheduling_k8s_io_v1_priorityclasses_name",
	...
	return models.Tool{
		Definition: tool,
		Handler:    PatchpriorityclassHandler(cfg),
	}
}
