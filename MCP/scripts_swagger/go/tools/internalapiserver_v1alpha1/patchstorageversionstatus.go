...
func PatchstorageversionstatusHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreatePatchstorageversionstatusTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("patch_apis_internal_apiserver_k8s_io_v1alpha1",
	...
	return models.Tool{
		Definition: tool,
		Handler:    PatchstorageversionstatusHandler(cfg),
	}
}
