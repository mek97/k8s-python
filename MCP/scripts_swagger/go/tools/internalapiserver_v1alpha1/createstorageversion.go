...
func CreatestorageversionHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateCreatestorageversionTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_apis_internal_apiserver_k8s_io_v1alpha1_storageversions",
	...
	return models.Tool{
		Definition: tool,
		Handler:    CreatestorageversionHandler(cfg),
	}
}
