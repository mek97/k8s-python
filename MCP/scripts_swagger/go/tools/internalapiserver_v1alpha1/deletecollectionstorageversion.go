...
func DeletecollectionstorageversionHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateDeletecollectionstorageversionTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_apis_internal_apiserver_k8s_io_v1alpha1",
	...
	return models.Tool{
		Definition: tool,
		Handler:    DeletecollectionstorageversionHandler(cfg),
	}
}
