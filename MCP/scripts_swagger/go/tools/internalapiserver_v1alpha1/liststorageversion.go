...
func ListstorageversionHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateListstorageversionTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_apis_internal_apiserver_k8s_io_v1alpha1_2",
	...
	return models.Tool{
		Definition: tool,
		Handler:    ListstorageversionHandler(cfg),
	}
}
