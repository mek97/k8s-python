...
func ReplacemutatingadmissionpolicyHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateReplacemutatingadmissionpolicyTool(cfg *config.APIConfig) models.Tool {
	...
	return models.Tool{
		Definition: tool,
		Handler:    ReplacemutatingadmissionpolicyHandler(cfg),
	}
}
