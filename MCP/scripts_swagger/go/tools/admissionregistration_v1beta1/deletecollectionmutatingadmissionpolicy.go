...
func DeletecollectionmutatingadmissionpolicyHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/apis/admissionregistration.k8s.io/v1beta1/mutatingadmissionpolicies%s", cfg.BaseURL, queryString)
...
func CreateDeletecollectionmutatingadmissionpolicyTool(cfg *config.APIConfig) models.Tool {
	...
	return models.Tool{
		Definition: tool,
		Handler:    DeletecollectionmutatingadmissionpolicyHandler(cfg),
	}
}
