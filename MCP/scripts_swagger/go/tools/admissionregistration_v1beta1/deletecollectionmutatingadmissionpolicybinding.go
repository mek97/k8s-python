...
func DeletecollectionmutatingadmissionpolicybindingHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/apis/admissionregistration.k8s.io/v1beta1/mutatingadmissionpolicybindings%s", cfg.BaseURL, queryString)
...
func CreateDeletecollectionmutatingadmissionpolicybindingTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_apis_admissionregistration_k8s_io_v1beta1",
	...
	return models.Tool{
		Definition: tool,
		Handler:    DeletecollectionmutatingadmissionpolicybindingHandler(cfg),
	}
}
