...
func CreatemutatingadmissionpolicybindingHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateCreatemutatingadmissionpolicybindingTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_apis_admissionregistration_k8s_io_v1beta1",
	...
	return models.Tool{
		Definition: tool,
		Handler:    CreatemutatingadmissionpolicybindingHandler(cfg),
	}
}
