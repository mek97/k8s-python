...
func ReplacemutatingadmissionpolicybindingHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateReplacemutatingadmissionpolicybindingTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_apis_admissionregistration_k8s_io_v1beta1",
	...
	return models.Tool{
		Definition: tool,
		Handler:    ReplacemutatingadmissionpolicybindingHandler(cfg),
	}
}
