...
func PatchmutatingadmissionpolicybindingHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/apis/admissionregistration.k8s.io/v1beta1/mutatingadmissionpolicybindings/%s%s", cfg.BaseURL, queryString)
...
func CreatePatchmutatingadmissionpolicybindingTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("patch_apis_admissionregistration_k8s_io_v1beta1",
		mcp.WithDescription("partially update the specified MutatingAdmissionPolicyBinding"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    PatchmutatingadmissionpolicybindingHandler(cfg),
	}
}
