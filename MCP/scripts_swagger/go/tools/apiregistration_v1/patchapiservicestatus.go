...
func PatchapiservicestatusHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreatePatchapiservicestatusTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("patch_apis_apiregistration_k8s_io_v1_apiservices_name_status",
	...
	return models.Tool{
		Definition: tool,
		Handler:    PatchapiservicestatusHandler(cfg),
	}
}
