...
func PatchapiserviceHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreatePatchapiserviceTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("patch_apis_apiregistration_k8s_io_v1_apiservices_name",
	...
	return models.Tool{
		Definition: tool,
		Handler:    PatchapiserviceHandler(cfg),
	}
}
