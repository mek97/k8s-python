...
func ListclustertrustbundleHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateListclustertrustbundleTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_apis_certificates_k8s_io_v1beta1_clustertrustbundles_2",
	...
	return models.Tool{
		Definition: tool,
		Handler:    ListclustertrustbundleHandler(cfg),
	}
}
