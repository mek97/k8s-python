...
func PatchingressclassHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreatePatchingressclassTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("patch_apis_networking_k8s_io_v1_ingressclasses_name",
	...
	return models.Tool{
		Definition: tool,
		Handler:    PatchingressclassHandler(cfg),
	}
}
