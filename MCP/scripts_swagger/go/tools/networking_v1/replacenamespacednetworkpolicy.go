...
func ReplacenamespacednetworkpolicyHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateReplacenamespacednetworkpolicyTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_apis_networking_k8s_io_v1_namespaces_namespace",
	...
	return models.Tool{
		Definition: tool,
		Handler:    ReplacenamespacednetworkpolicyHandler(cfg),
	}
}
