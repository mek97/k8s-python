...
func PatchservicecidrstatusHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreatePatchservicecidrstatusTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("patch_apis_networking_k8s_io_v1_servicecidrs_name_status",
		mcp.WithDescription("partially update status of the specified ServiceCIDR"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    PatchservicecidrstatusHandler(cfg),
	}
}
