...
func CreatenamespacednetworkpolicyHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateCreatenamespacednetworkpolicyTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_apis_networking_k8s_io_v1_namespaces_namespace",
	...
	return models.Tool{
		Definition: tool,
		Handler:    CreatenamespacednetworkpolicyHandler(cfg),
	}
}
