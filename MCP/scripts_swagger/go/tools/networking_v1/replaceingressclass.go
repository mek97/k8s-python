...
func ReplaceingressclassHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateReplaceingressclassTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_apis_networking_k8s_io_v1_ingressclasses_name",
	...
	return models.Tool{
		Definition: tool,
		Handler:    ReplaceingressclassHandler(cfg),
	}
}
