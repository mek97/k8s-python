...
func ListingressclassHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateListingressclassTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_apis_networking_k8s_io_v1_ingressclasses",
	...
	return models.Tool{
		Definition: tool,
		Handler:    ListingressclassHandler(cfg),
	}
}
