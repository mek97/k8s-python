...
func DeletecollectioningressclassHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateDeletecollectioningressclassTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_apis_networking_k8s_io_v1_ingressclasses",
	...
	return models.Tool{
		Definition: tool,
		Handler:    DeletecollectioningressclassHandler(cfg),
	}
}
