...
func DeleteingressclassHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateDeleteingressclassTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_apis_networking_k8s_io_v1_ingressclasses_name",
	...
	return models.Tool{
		Definition: tool,
		Handler:    DeleteingressclassHandler(cfg),
	}
}
