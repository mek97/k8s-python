...
func ReplacenamespacedreplicationcontrollerscaleHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateReplacenamespacedreplicationcontrollerscaleTool(cfg *config.APIConfig) models.Tool {
	...
	return models.Tool{
		Definition: tool,
		Handler:    ReplacenamespacedreplicationcontrollerscaleHandler(cfg),
	}
}
