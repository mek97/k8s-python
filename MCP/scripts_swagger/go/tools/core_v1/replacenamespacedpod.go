...
func ReplacenamespacedpodHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateReplacenamespacedpodTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_api_v1_namespaces_namespace_pods_name_2",
	...
	return models.Tool{
		Definition: tool,
		Handler:    ReplacenamespacedpodHandler(cfg),
	}
}
