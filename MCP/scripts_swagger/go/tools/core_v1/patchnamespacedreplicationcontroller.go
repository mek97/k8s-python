...
func PatchnamespacedreplicationcontrollerHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreatePatchnamespacedreplicationcontrollerTool(cfg *config.APIConfig) models.Tool {
	...
	return models.Tool{
		Definition: tool,
		Handler:    PatchnamespacedreplicationcontrollerHandler(cfg),
	}
}
