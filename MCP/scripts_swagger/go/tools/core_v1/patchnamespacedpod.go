...
func PatchnamespacedpodHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreatePatchnamespacedpodTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("patch_api_v1_namespaces_namespace_pods_name_2",
	...
	return models.Tool{
		Definition: tool,
		Handler:    PatchnamespacedpodHandler(cfg),
	}
}
