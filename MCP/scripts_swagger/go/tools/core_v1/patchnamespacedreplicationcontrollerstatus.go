...
func PatchnamespacedreplicationcontrollerstatusHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreatePatchnamespacedreplicationcontrollerstatusTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("patch_api_v1_namespaces_namespace_replicationcontrollers",
	...
	return models.Tool{
		Definition: tool,
		Handler:    PatchnamespacedreplicationcontrollerstatusHandler(cfg),
	}
}
