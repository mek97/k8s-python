...
func PatchnamespacedpersistentvolumeclaimstatusHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreatePatchnamespacedpersistentvolumeclaimstatusTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("patch_api_v1_namespaces_namespace_persistentvolumeclaims",
	...
	return models.Tool{
		Definition: tool,
		Handler:    PatchnamespacedpersistentvolumeclaimstatusHandler(cfg),
	}
}
