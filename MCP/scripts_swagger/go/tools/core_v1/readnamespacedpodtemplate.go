...
func ReadnamespacedpodtemplateHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateReadnamespacedpodtemplateTool(cfg *config.APIConfig) models.Tool {
	...
	return models.Tool{
		Definition: tool,
		Handler:    ReadnamespacedpodtemplateHandler(cfg),
	}
}
