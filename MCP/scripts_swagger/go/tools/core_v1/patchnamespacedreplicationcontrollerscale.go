...
func PatchnamespacedreplicationcontrollerscaleHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreatePatchnamespacedreplicationcontrollerscaleTool(cfg *config.APIConfig) models.Tool {
	...
	return models.Tool{
		Definition: tool,
		Handler:    PatchnamespacedreplicationcontrollerscaleHandler(cfg),
	}
}
