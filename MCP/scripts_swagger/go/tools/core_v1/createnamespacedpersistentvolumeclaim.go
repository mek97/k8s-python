...
func CreatenamespacedpersistentvolumeclaimHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateCreatenamespacedpersistentvolumeclaimTool(cfg *config.APIConfig) models.Tool {
	...
	return models.Tool{
		Definition: tool,
		Handler:    CreatenamespacedpersistentvolumeclaimHandler(cfg),
	}
}
