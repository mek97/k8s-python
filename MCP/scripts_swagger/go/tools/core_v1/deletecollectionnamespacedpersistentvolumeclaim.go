...
func DeletecollectionnamespacedpersistentvolumeclaimHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateDeletecollectionnamespacedpersistentvolumeclaimTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_api_v1_namespaces_namespace_persistentvolumeclaims_2",
	...
	return models.Tool{
		Definition: tool,
		Handler:    DeletecollectionnamespacedpersistentvolumeclaimHandler(cfg),
	}
}
