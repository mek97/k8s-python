...
func ReadnodeHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateReadnodeTool(cfg *config.APIConfig) models.Tool {
