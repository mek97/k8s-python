...
func ListnamespacedconfigmapHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateListnamespacedconfigmapTool(cfg *config.APIConfig) models.Tool {
	...
	return models.Tool{
		Definition: tool,
		Handler:    ListnamespacedconfigmapHandler(cfg),
	}
}
