...
func CreatenamespacedreplicationcontrollerHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateCreatenamespacedreplicationcontrollerTool(cfg *config.APIConfig) models.Tool {
	...
	return models.Tool{
		Definition: tool,
		Handler:    CreatenamespacedreplicationcontrollerHandler(cfg),
	}
}
