...
func ReplacenamespacedpersistentvolumeclaimHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateReplacenamespacedpersistentvolumeclaimTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_api_v1_namespaces_namespace_persistentvolumeclaims_2",
	...
	return models.Tool{
		Definition: tool,
		Handler:    ReplacenamespacedpersistentvolumeclaimHandler(cfg),
	}
}
