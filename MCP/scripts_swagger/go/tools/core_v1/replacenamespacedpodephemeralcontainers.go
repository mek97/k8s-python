...
func ReplacenamespacedpodephemeralcontainersHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateReplacenamespacedpodephemeralcontainersTool(cfg *config.APIConfig) models.Tool {
	...
	return models.Tool{
		Definition: tool,
		Handler:    ReplacenamespacedpodephemeralcontainersHandler(cfg),
	}
}
