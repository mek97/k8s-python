...
func ReplacenamespacedpersistentvolumeclaimstatusHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateReplacenamespacedpersistentvolumeclaimstatusTool(cfg *config.APIConfig) models.Tool {
	...
	return models.Tool{
		Definition: tool,
		Handler:    ReplacenamespacedpersistentvolumeclaimstatusHandler(cfg),
	}
}
