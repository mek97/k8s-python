...
func ReplacenamespacedstatefulsetHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateReplacenamespacedstatefulsetTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_apis_apps_v1_namespaces_namespace_statefulsets_name_2",
	...
	return models.Tool{
		Definition: tool,
		Handler:    ReplacenamespacedstatefulsetHandler(cfg),
	}
}
