...
func PatchnamespaceddeploymentscaleHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreatePatchnamespaceddeploymentscaleTool(cfg *config.APIConfig) models.Tool {
	...
	return models.Tool{
		Definition: tool,
		Handler:    PatchnamespaceddeploymentscaleHandler(cfg),
	}
}
