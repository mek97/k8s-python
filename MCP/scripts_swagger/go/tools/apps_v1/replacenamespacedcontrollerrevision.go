...
func ReplacenamespacedcontrollerrevisionHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateReplacenamespacedcontrollerrevisionTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_apis_apps_v1_namespaces_namespace_controllerrevisions",
	...
	return models.Tool{
		Definition: tool,
		Handler:    ReplacenamespacedcontrollerrevisionHandler(cfg),
	}
}
