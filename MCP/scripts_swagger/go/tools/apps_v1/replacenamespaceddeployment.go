...
func ReplacenamespaceddeploymentHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateReplacenamespaceddeploymentTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_apis_apps_v1_namespaces_namespace_deployments_name_2",
	...
	return models.Tool{
		Definition: tool,
		Handler:    ReplacenamespaceddeploymentHandler(cfg),
	}
}
