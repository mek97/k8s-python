...
func DeletecollectionnamespacedreplicasetHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateDeletecollectionnamespacedreplicasetTool(cfg *config.APIConfig) models.Tool {
	...
	return models.Tool{
		Definition: tool,
		Handler:    DeletecollectionnamespacedreplicasetHandler(cfg),
	}
}
