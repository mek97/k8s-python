...
func PatchnamespacedcontrollerrevisionHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreatePatchnamespacedcontrollerrevisionTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("patch_apis_apps_v1_namespaces_namespace_controllerrevisions",
	...
	return models.Tool{
		Definition: tool,
		Handler:    PatchnamespacedcontrollerrevisionHandler(cfg),
	}
}
