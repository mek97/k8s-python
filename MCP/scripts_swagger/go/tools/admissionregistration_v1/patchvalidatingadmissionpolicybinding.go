...
func PatchvalidatingadmissionpolicybindingHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreatePatchvalidatingadmissionpolicybindingTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("patch_apis_admissionregistration_k8s_io_v1",
	...
	return models.Tool{
		Definition: tool,
		Handler:    PatchvalidatingadmissionpolicybindingHandler(cfg),
	}
}
