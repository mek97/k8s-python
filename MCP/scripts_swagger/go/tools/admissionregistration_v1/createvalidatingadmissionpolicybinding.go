...
func CreatevalidatingadmissionpolicybindingHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateCreatevalidatingadmissionpolicybindingTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_apis_admissionregistration_k8s_io_v1",
	...
	return models.Tool{
		Definition: tool,
		Handler:    CreatevalidatingadmissionpolicybindingHandler(cfg),
	}
}
