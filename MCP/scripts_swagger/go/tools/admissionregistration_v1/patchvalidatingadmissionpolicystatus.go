...
func PatchvalidatingadmissionpolicystatusHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreatePatchvalidatingadmissionpolicystatusTool(cfg *config.APIConfig) models.Tool {
	...
	return models.Tool{
		Definition: tool,
		Handler:    PatchvalidatingadmissionpolicystatusHandler(cfg),
	}
}
