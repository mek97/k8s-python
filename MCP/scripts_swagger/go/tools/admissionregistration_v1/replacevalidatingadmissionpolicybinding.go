...
func ReplacevalidatingadmissionpolicybindingHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateReplacevalidatingadmissionpolicybindingTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_apis_admissionregistration_k8s_io_v1",
	...
	return models.Tool{
		Definition: tool,
		Handler:    ReplacevalidatingadmissionpolicybindingHandler(cfg),
	}
}
