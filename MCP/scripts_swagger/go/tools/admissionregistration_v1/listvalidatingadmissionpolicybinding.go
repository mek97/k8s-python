...
func ListvalidatingadmissionpolicybindingHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateListvalidatingadmissionpolicybindingTool(cfg *config.APIConfig) models.Tool {
	...
	return models.Tool{
		Definition: tool,
		Handler:    ListvalidatingadmissionpolicybindingHandler(cfg),
	}
}
