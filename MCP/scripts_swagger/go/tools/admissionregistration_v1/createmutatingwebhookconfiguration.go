...
func CreatemutatingwebhookconfigurationHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateCreatemutatingwebhookconfigurationTool(cfg *config.APIConfig) models.Tool {
	...
	return models.Tool{
		Definition: tool,
		Handler:    CreatemutatingwebhookconfigurationHandler(cfg),
	}
}
