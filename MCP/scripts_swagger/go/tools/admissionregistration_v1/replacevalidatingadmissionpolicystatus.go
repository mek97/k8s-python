...
func ReplacevalidatingadmissionpolicystatusHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateReplacevalidatingadmissionpolicystatusTool(cfg *config.APIConfig) models.Tool {
	...
	return models.Tool{
		Definition: tool,
		Handler:    ReplacevalidatingadmissionpolicystatusHandler(cfg),
	}
}
