...
func ReplacevalidatingwebhookconfigurationHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateReplacevalidatingwebhookconfigurationTool(cfg *config.APIConfig) models.Tool {
	...
	return models.Tool{
		Definition: tool,
		Handler:    ReplacevalidatingwebhookconfigurationHandler(cfg),
	}
}
