...
func PatchipaddressHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreatePatchipaddressTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("patch_apis_networking_k8s_io_v1beta1_ipaddresses_name",
	...
	return models.Tool{
		Definition: tool,
		Handler:    PatchipaddressHandler(cfg),
	}
}
