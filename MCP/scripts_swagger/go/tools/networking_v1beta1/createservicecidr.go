...
func CreateservicecidrHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateCreateservicecidrTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_apis_networking_k8s_io_v1beta1_servicecidrs",
	...
	return models.Tool{
		Definition: tool,
		Handler:    CreateservicecidrHandler(cfg),
	}
}
