...
func PatchservicecidrHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreatePatchservicecidrTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("patch_apis_networking_k8s_io_v1beta1_servicecidrs_name_2",
		mcp.WithDescription("partially update the specified ServiceCIDR"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    PatchservicecidrHandler(cfg),
	}
}
