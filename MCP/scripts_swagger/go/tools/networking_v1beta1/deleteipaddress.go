...
func DeleteipaddressHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateDeleteipaddressTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_apis_networking_k8s_io_v1beta1_ipaddresses_name",
	...
	return models.Tool{
		Definition: tool,
		Handler:    DeleteipaddressHandler(cfg),
	}
}
