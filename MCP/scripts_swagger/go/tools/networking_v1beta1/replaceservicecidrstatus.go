...
func ReplaceservicecidrstatusHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateReplaceservicecidrstatusTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_apis_networking_k8s_io_v1beta1_servicecidrs_name_status",
	...
	return models.Tool{
		Definition: tool,
		Handler:    ReplaceservicecidrstatusHandler(cfg),
	}
}
