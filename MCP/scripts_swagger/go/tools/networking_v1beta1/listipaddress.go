...
func ListipaddressHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateListipaddressTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_apis_networking_k8s_io_v1beta1_ipaddresses",
	...
	return models.Tool{
		Definition: tool,
		Handler:    ListipaddressHandler(cfg),
	}
}
