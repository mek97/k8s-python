...
func CreateipaddressHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateCreateipaddressTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_apis_networking_k8s_io_v1beta1_ipaddresses",
	...
	return models.Tool{
		Definition: tool,
		Handler:    CreateipaddressHandler(cfg),
	}
}
