...
func DeleteservicecidrHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateDeleteservicecidrTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_apis_networking_k8s_io_v1beta1_servicecidrs_name",
	...
	return models.Tool{
		Definition: tool,
		Handler:    DeleteservicecidrHandler(cfg),
	}
}
