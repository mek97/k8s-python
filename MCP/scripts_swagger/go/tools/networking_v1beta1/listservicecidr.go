...
func ListservicecidrHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateListservicecidrTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_apis_networking_k8s_io_v1beta1_servicecidrs",
	...
	return models.Tool{
		Definition: tool,
		Handler:    ListservicecidrHandler(cfg),
	}
}
