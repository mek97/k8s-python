...
func PatchnamespacedhorizontalpodautoscalerstatusHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreatePatchnamespacedhorizontalpodautoscalerstatusTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("patch_apis_autoscaling_v1_namespaces_namespace",
	...
	return models.Tool{
		Definition: tool,
		Handler:    PatchnamespacedhorizontalpodautoscalerstatusHandler(cfg),
	}
}
