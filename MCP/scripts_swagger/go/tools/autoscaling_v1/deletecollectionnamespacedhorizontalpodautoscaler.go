...
func DeletecollectionnamespacedhorizontalpodautoscalerHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateDeletecollectionnamespacedhorizontalpodautoscalerTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_apis_autoscaling_v1_namespaces_namespace",
	...
	return models.Tool{
		Definition: tool,
		Handler:    DeletecollectionnamespacedhorizontalpodautoscalerHandler(cfg),
	}
}
