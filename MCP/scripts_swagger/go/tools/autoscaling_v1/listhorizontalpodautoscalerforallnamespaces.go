...
func ListhorizontalpodautoscalerforallnamespacesHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateListhorizontalpodautoscalerforallnamespacesTool(cfg *config.APIConfig) models.Tool {
	...
	return models.Tool{
		Definition: tool,
		Handler:    ListhorizontalpodautoscalerforallnamespacesHandler(cfg),
	}
}
