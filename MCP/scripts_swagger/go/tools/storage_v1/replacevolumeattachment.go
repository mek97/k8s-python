...
func ReplacevolumeattachmentHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateReplacevolumeattachmentTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_apis_storage_k8s_io_v1_volumeattachments_name",
	...
	return models.Tool{
		Definition: tool,
		Handler:    ReplacevolumeattachmentHandler(cfg),
	}
}
