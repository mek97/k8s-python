...
func DeletecollectionvolumeattachmentHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateDeletecollectionvolumeattachmentTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_apis_storage_k8s_io_v1_volumeattachments",
	...
	return models.Tool{
		Definition: tool,
		Handler:    DeletecollectionvolumeattachmentHandler(cfg),
	}
}
