...
func DeletecsidriverHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateDeletecsidriverTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_apis_storage_k8s_io_v1_csidrivers_name",
	...
	return models.Tool{
		Definition: tool,
		Handler:    DeletecsidriverHandler(cfg),
	}
}
