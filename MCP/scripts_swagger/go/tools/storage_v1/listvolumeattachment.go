...
func ListvolumeattachmentHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateListvolumeattachmentTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_apis_storage_k8s_io_v1_volumeattachments",
	...
	return models.Tool{
		Definition: tool,
		Handler:    ListvolumeattachmentHandler(cfg),
	}
}
