...
func ReplacevolumeattachmentstatusHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateReplacevolumeattachmentstatusTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_apis_storage_k8s_io_v1_volumeattachments_name_status",
	...
	return models.Tool{
		Definition: tool,
		Handler:    ReplacevolumeattachmentstatusHandler(cfg),
	}
}
