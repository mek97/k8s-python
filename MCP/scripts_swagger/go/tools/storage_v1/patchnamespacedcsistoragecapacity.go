...
func PatchnamespacedcsistoragecapacityHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreatePatchnamespacedcsistoragecapacityTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("patch_apis_storage_k8s_io_v1_namespaces_namespace",
	...
	return models.Tool{
		Definition: tool,
		Handler:    PatchnamespacedcsistoragecapacityHandler(cfg),
	}
}
