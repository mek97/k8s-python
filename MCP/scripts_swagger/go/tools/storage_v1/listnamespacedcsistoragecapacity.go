...
func ListnamespacedcsistoragecapacityHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateListnamespacedcsistoragecapacityTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_apis_storage_k8s_io_v1_namespaces_namespace",
	...
	return models.Tool{
		Definition: tool,
		Handler:    ListnamespacedcsistoragecapacityHandler(cfg),
	}
}
