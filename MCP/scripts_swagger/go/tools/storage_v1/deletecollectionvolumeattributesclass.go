...
func DeletecollectionvolumeattributesclassHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/apis/storage.k8s.io/v1/volumeattributesclasses%s", cfg.BaseURL, queryString)
...
func CreateDeletecollectionvolumeattributesclassTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_apis_storage_k8s_io_v1_volumeattributesclasses",
	...
	return models.Tool{
		Definition: tool,
		Handler:    DeletecollectionvolumeattributesclassHandler(cfg),
	}
}
