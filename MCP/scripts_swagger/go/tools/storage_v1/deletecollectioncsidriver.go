...
func DeletecollectioncsidriverHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateDeletecollectioncsidriverTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_apis_storage_k8s_io_v1_csidrivers",
	...
	return models.Tool{
		Definition: tool,
		Handler:    DeletecollectioncsidriverHandler(cfg),
	}
}
