...
func DeletecollectioncsinodeHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateDeletecollectioncsinodeTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_apis_storage_k8s_io_v1_csinodes",
	...
	return models.Tool{
		Definition: tool,
		Handler:    DeletecollectioncsinodeHandler(cfg),
	}
}
