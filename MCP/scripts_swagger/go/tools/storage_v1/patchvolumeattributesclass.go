...
func PatchvolumeattributesclassHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/apis/storage.k8s.io/v1/volumeattributesclasses/%s%s", cfg.BaseURL, queryString)
...
func CreatePatchvolumeattributesclassTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("patch_apis_storage_k8s_io_v1_volumeattributesclasses_name",
		mcp.WithDescription("partially update the specified VolumeAttributesClass"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    PatchvolumeattributesclassHandler(cfg),
	}
}
