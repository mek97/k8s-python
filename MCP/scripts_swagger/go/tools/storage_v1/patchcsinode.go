...
func PatchcsinodeHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreatePatchcsinodeTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("patch_apis_storage_k8s_io_v1_csinodes_name",
	...
	return models.Tool{
		Definition: tool,
		Handler:    PatchcsinodeHandler(cfg),
	}
}
