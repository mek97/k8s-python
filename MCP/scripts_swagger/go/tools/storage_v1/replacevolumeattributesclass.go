...
func ReplacevolumeattributesclassHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateReplacevolumeattributesclassTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_apis_storage_k8s_io_v1_volumeattributesclasses_name",
	...
	return models.Tool{
		Definition: tool,
		Handler:    ReplacevolumeattributesclassHandler(cfg),
	}
}
