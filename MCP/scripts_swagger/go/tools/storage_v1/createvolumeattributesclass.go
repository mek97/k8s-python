...
func CreatevolumeattributesclassHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateCreatevolumeattributesclassTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_apis_storage_k8s_io_v1_volumeattributesclasses",
	...
	return models.Tool{
		Definition: tool,
		Handler:    CreatevolumeattributesclassHandler(cfg),
	}
}
