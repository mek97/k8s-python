...
func DeleteruntimeclassHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateDeleteruntimeclassTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_apis_node_k8s_io_v1_runtimeclasses_name",
	...
	return models.Tool{
		Definition: tool,
		Handler:    DeleteruntimeclassHandler(cfg),
	}
}
