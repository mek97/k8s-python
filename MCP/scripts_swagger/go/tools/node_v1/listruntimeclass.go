...
func ListruntimeclassHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateListruntimeclassTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_apis_node_k8s_io_v1_runtimeclasses",
	...
	return models.Tool{
		Definition: tool,
		Handler:    ListruntimeclassHandler(cfg),
	}
}
