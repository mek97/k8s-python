...
func CreateruntimeclassHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateCreateruntimeclassTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_apis_node_k8s_io_v1_runtimeclasses",
	...
	return models.Tool{
		Definition: tool,
		Handler:    CreateruntimeclassHandler(cfg),
	}
}
